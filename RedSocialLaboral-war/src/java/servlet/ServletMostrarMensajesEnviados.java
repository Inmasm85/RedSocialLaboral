 ...
 */
@WebServlet(name = "ServletMostrarMensajesEnviados", urlPatterns = {"/ServletMostrarMensajesEnviados"})
public class ServletMostrarMensajesEnviados extends HttpServlet {
    ...
    public ServletMostrarMensajesEnviados(){
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        mensajes = (Collection<Mensaje>) mensajeFacade.findByEmisor(usuario);
        String n = "ServletMostrarMensajesEnviados";
